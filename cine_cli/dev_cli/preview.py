...
preview_app = typer.Typer(
    name = "preview", 
    help = "Dev command used by stuff like fzf to display images from cine-cli in the terminal."
)

@preview_app.command(help = "Preview image from cine-cli cache to terminal.")
def image(id: str):
