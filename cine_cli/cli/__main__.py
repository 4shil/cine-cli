...
def cine_cli(
    ...
    version: bool = typer.Option(False, "--version", help = "Display what version cine-cli is currently on."), 
    edit: bool = typer.Option(False, "--edit", "-e", help = "Opens the cine-cli config with your respective editor."), 
    ...
    clear_cache: bool = typer.Option(False, "--no-cache", "--clear-cache", help = "Clears ALL cache stored by cine-cli, including the temp directory cache."),
    ...
    if config.debug:
        cine_cli_logger.setLevel(logging.DEBUG)

    if clear_cache:
        cine_cli_logger.info("Clearing cache...")
    ...
    cine_cli_logger.debug(f"Config -> {config.data}")
    ...
    if query is not None:
        ...
        # https://github.com/cine-cli/cine-cli-youtube/commit/b538d82745a743cd74a02530d6a3d476cd60b808#diff-4e5b064838aa74a5375265f4dfbd94024b655ee24a191290aacd3673abed921a
