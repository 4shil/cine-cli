...
def get_appdata_directory(platform: SUPPORTED_PLATFORMS) -> Path:
    """Returns the path to the cine-cli appdata folder on multiple platforms."""
    appdata_dir = None
    ...
    appdata_dir = appdata_dir.joinpath("cine-cli")
...
def get_temp_directory(platform: SUPPORTED_PLATFORMS) -> Path:
    """
    Returns the temporary directory where cine-cli can dump stuff. 
    ...
    temp_directory = temp_directory.joinpath("cine-cli-temp")
...
def get_cache_directory(platform: SUPPORTED_PLATFORMS) -> Path:
    """
    Returns the cache directory where cine-cli can dump longer lived cache.
    """
    ...
    cache_directory = cache_directory.joinpath("cine-cli")
